...
public class TravelPlanningRestController {
	...
	ITravelPlanningService planningService;
	 ...
	 public List<TravelPlanning> getPlannings() {
		...
		@GetMapping("/retrieve-travelPlanning/{planning-id}")
		@ResponseBody
		public TravelPlanning retrieveTravelPlanning(@PathVariable("planning-id") Long idPlanning) {
		return planningService.retrieveTravelPlanningById(idPlanning);
		}
		
		@PutMapping("/modify-travel¨Planning-byID/{planning-id}")
		@ResponseBody
		public TravelPlanning ModifyTravelPlanningById(@PathVariable("planning-id") Long idPlanning,@RequestBody TravelPlanning t) {
		return planningService.updateTravelPlanningById(t, idPlanning);
		}
