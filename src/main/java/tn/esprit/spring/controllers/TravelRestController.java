...
public class TravelRestController {
  ...
  ITravelService travelservice;
	...
	@ResponseBody
	public String AffectTravelToTraveler(@PathVariable("travel-id") Long idTravel , @PathVariable("user-id") Long idUser) {
		return travelservice.affecterTraveltoTraveler(idTravel, idUser);
	}
	...
	//http://localhost:8089/SpringMVC/travel/modify-travel
		...
		@GetMapping("/retrieve-friend/{user-id}")
		@ResponseBody
		public Set<User> retrieveFriend(@PathVariable("user-id") Long idUser) {
